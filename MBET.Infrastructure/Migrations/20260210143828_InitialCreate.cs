    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuditLogs", x => x.Guid);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NoReplyEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    DefaultTaxRate = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BanDuratyionDays = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    PreferredLanguage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ShippingStreet = table.Column<string>(type: "nvarchar(256)", nullable: true),
                    ShippingCity = table.Column<string>(type: "nvarchar(256)", nullable: true),
                    ShippingState = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShippingZipCode = table.Column<string>(type: "nvarchar(256)", nullable: true),
                    ShippingCountry = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BillingStreet = table.Column<string>(type: "nvarchar(256)", nullable: true),
                    BillingCity = table.Column<string>(type: "nvarchar(256)", nullable: true),
                    BillingState = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BillingZipCode = table.Column<string>(type: "nvarchar(256)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingAddress = table.Column<string>(type: "nvarchar(256)", nullable: true),
                    CustomerName = table.Column<string>(type: "nvarchar(256)", nullable: true),
                    CustomerPhone = table.Column<string>(type: "nvarchar(256)", nullable: true),
